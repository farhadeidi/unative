...
const Backward10SecondsBroken = ({
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M3.99023 16.96C5.42023 19.94 8.47024 22 12.0002 22C16.9102 22 20.8903 18.02 20.8903 13.11C20.8903 8.19999 16.9102 4.21997 12.0002 4.21997C11.3202 4.21997 10.6602 4.31002 10.0202 4.46002"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M4.90939 7.80005C3.79939 9.28005 3.10938 11.11 3.10938 13.11"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M9.53906 15.92V10.5801L8.03906 12.2501"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const Backward10SecondsOutline = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const Backward10SecondsTwotone = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const variants: IconVariants = {
  bold: Backward10SecondsBold,
  broken: Backward10SecondsBroken,
  bulk: Backward10SecondsBulk,
  linear: Backward10SecondsLinear,
  outline: Backward10SecondsOutline,
  twotone: Backward10SecondsTwotone,
};

export const Backward10SecondsIcon = ({
  variant = "linear",
  className,
  ...props
}: IconProps) => {
