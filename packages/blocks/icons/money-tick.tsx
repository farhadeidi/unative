...
const MoneyTickBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyTickBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyTickBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyTickLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyTickOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M4.4289 19.7401C4.2389 19.7401 4.0489 19.6701 3.8989 19.5201L2.90891 18.5301C2.61891 18.2401 2.61891 17.76 2.90891 17.47C3.19891 17.18 3.6789 17.18 3.9689 17.47L4.44891 17.9501L6.04889 16.47C6.34889 16.19 6.82889 16.2101 7.10889 16.5101C7.38889 16.8101 7.36891 17.2901 7.06891 17.5701L4.93891 19.54C4.7889 19.67 4.6089 19.7401 4.4289 19.7401Z"
        fill="currentColor"
      />
      <Path
...
const MoneyTickTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: MoneyTickBold,
  broken: MoneyTickBroken,
  bulk: MoneyTickBulk,
  linear: MoneyTickLinear,
  outline: MoneyTickOutline,
  twotone: MoneyTickTwotone,
};

export const MoneyTickIcon = ({ variant = "linear", ...props }: IconProps) => {
