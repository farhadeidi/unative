...
const GalleryEditBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const GalleryEditBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M18.6191 3.11011C18.9291 4.21011 19.7891 5.07011 20.8891 5.38011"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const GalleryEditBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const GalleryEditLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const GalleryEditOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M15.6709 9.74994C15.2809 9.74994 14.9209 9.60994 14.6609 9.33994C14.3509 9.02994 14.2009 8.56994 14.2709 8.09994L14.4709 6.70994C14.5209 6.35994 14.7309 5.92994 14.9909 5.67994L18.6209 2.04994C20.0709 0.599939 21.3309 1.42994 21.9509 2.04994C22.5409 2.63994 22.8109 3.25994 22.7509 3.89994C22.7009 4.40994 22.4409 4.89994 21.9509 5.37994L18.3209 9.00994C18.0709 9.25994 17.6409 9.46994 17.2909 9.52994L15.9009 9.72994C15.8209 9.74994 15.7409 9.74994 15.6709 9.74994ZM19.6709 3.11994L16.0409 6.74994C16.0109 6.77994 15.9609 6.88994 15.9509 6.93994L15.7609 8.23994L17.0709 8.05994C17.1109 8.04994 17.2209 7.99994 17.2609 7.95994L20.8909 4.32994C21.1109 4.10994 21.2409 3.90994 21.2509 3.75994C21.2709 3.54994 21.0609 3.28994 20.8909 3.11994C20.3709 2.59994 20.1309 2.65994 19.6709 3.11994Z"
        fill="currentColor"
      />
      <Path
        d="M20.9003 6.12976C20.8303 6.12976 20.7603 6.11976 20.7003 6.09976C19.3603 5.71976 18.2903 4.64976 17.9103 3.30976C17.8003 2.90976 18.0303 2.49976 18.4303 2.38976C18.8303 2.27976 19.2403 2.50976 19.3503 2.90976C19.5903 3.74976 20.2603 4.42976 21.1103 4.66976C21.5103 4.77976 21.7403 5.19976 21.6303 5.58976C21.5203 5.90976 21.2203 6.12976 20.9003 6.12976Z"
        fill="currentColor"
      />
      <Path
...
const GalleryEditTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: GalleryEditBold,
  broken: GalleryEditBroken,
  bulk: GalleryEditBulk,
  linear: GalleryEditLinear,
  outline: GalleryEditOutline,
  twotone: GalleryEditTwotone,
};
