...
const TextalignJustifycenterBold = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const TextalignJustifycenterBroken = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const TextalignJustifycenterBulk = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const TextalignJustifycenterLinear = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const TextalignJustifycenterOutline = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const TextalignJustifycenterTwotone = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const variants: IconVariants = {
  bold: TextalignJustifycenterBold,
  broken: TextalignJustifycenterBroken,
  bulk: TextalignJustifycenterBulk,
  linear: TextalignJustifycenterLinear,
  outline: TextalignJustifycenterOutline,
  twotone: TextalignJustifycenterTwotone,
};
