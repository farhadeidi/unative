...
const SearchZoomOut1Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const SearchZoomOut1Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M14.25 11C14.25 11.41 13.91 11.75 13.5 11.75H8.5C8.09 11.75 7.75 11.41 7.75 11C7.75 10.59 8.09 10.25 8.5 10.25H13.5C13.91 10.25 14.25 10.59 14.25 11Z"
        fill="currentColor"
      />
      <Path
...
const variants: IconVariants = {
  bold: SearchZoomOut1Bold,
  broken: SearchZoomOut1Broken,
  bulk: SearchZoomOut1Bulk,
  linear: SearchZoomOut1Linear,
  outline: SearchZoomOut1Outline,
  twotone: SearchZoomOut1Twotone,
};
