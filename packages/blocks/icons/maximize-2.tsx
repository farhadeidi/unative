...
const Maximize2Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Maximize2Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Maximize2Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M17.0892 22.0002H15.6992C15.2892 22.0002 14.9492 21.6602 14.9492 21.2502C14.9492 20.8402 15.2892 20.5002 15.6992 20.5002H17.0892C18.9692 20.5002 20.4992 18.9702 20.4992 17.0902V15.7002C20.4992 15.2902 20.8392 14.9502 21.2492 14.9502C21.6592 14.9502 21.9992 15.2902 21.9992 15.7002V17.0902C21.9992 19.8002 19.7992 22.0002 17.0892 22.0002Z"
        fill="currentColor"
      />
      <Path
        d="M9.22 21.9998H6.91C4.2 21.9998 2 19.7998 2 17.0898V14.7798C2 14.3698 2.34 14.0298 2.75 14.0298C3.16 14.0298 3.5 14.3698 3.5 14.7798V17.0898C3.5 18.9698 5.03 20.4998 6.91 20.4998H9.22C9.63 20.4998 9.97 20.8398 9.97 21.2498C9.97 21.6598 9.64 21.9998 9.22 21.9998Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const Maximize2Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M18 12V10M6 12H12H18H6ZM6 12V10V12ZM6 12V14V12ZM18 12V14V12Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M12 6H14M12 18V6V18ZM12 18H14H12ZM12 18H10H12ZM12 6H10H12Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const Maximize2Outline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Maximize2Twotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: Maximize2Bold,
  broken: Maximize2Broken,
  bulk: Maximize2Bulk,
  linear: Maximize2Linear,
  outline: Maximize2Outline,
  twotone: Maximize2Twotone,
};

export const Maximize2Icon = ({ variant = "linear", ...props }: IconProps) => {
