...
const ArrowLeftBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowLeftBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowLeftBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowLeftLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowLeftOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowLeftTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: ArrowLeftBold,
  broken: ArrowLeftBroken,
  bulk: ArrowLeftBulk,
  linear: ArrowLeftLinear,
  outline: ArrowLeftOutline,
  twotone: ArrowLeftTwotone,
};

export const ArrowLeftIcon = ({ variant = "linear", ...props }: IconProps) => {
