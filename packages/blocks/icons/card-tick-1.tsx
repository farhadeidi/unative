...
const CardTick1Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardTick1Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardTick1Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardTick1Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardTick1Outline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M17.4289 19.7401C17.2389 19.7401 17.049 19.6701 16.899 19.5201L15.9089 18.5301C15.6189 18.2401 15.6189 17.7601 15.9089 17.4701C16.1989 17.1801 16.6789 17.1801 16.9689 17.4701L17.4489 17.9501L19.0489 16.4701C19.3489 16.1901 19.8289 16.2101 20.1089 16.5101C20.3889 16.8101 20.3689 17.2901 20.0689 17.5701L17.9389 19.54C17.7889 19.67 17.6089 19.7401 17.4289 19.7401Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const CardTick1Twotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: CardTick1Bold,
  broken: CardTick1Broken,
  bulk: CardTick1Bulk,
  linear: CardTick1Linear,
  outline: CardTick1Outline,
  twotone: CardTick1Twotone,
};

export const CardTick1Icon = ({ variant = "linear", ...props }: IconProps) => {
