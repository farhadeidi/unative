...
const ArrowCircleLeftBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowCircleLeftBroken = ({
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M13.2602 15.53L9.74023 12L10.7002 11.03L12.9002 8.82997L13.2602 8.46997"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const ArrowCircleLeftBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  ...
  broken: ArrowCircleLeftBroken,
  bulk: ArrowCircleLeftBulk,
  linear: ArrowCircleLeftLinear,
  outline: ArrowCircleLeftOutline,
  twotone: ArrowCircleLeftTwotone,
};
