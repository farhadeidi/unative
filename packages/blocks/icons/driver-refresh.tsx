...
const DriverRefreshBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DriverRefreshBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DriverRefreshBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M12.18 11.25C11.66 11.68 11.2 12.19 10.81 12.75H2V11.25H12.18Z"
        fill="currentColor"
      />
      <Path
...
const DriverRefreshLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DriverRefreshTwotone = ({
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M21.5604 20.33C21.0004 21.3 19.9504 21.95 18.7504 21.95C16.9604 21.95 15.8604 20.15 15.8604 20.15M15.9304 17.09C16.4904 16.11 17.5404 15.46 18.7504 15.46C20.9204 15.46 22.0004 17.26 22.0004 17.26M22.0004 15.25V17.25H20.0004M17.8604 20.14H15.8604V22"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const variants: IconVariants = {
  bold: DriverRefreshBold,
  broken: DriverRefreshBroken,
  bulk: DriverRefreshBulk,
  linear: DriverRefreshLinear,
  outline: DriverRefreshOutline,
  twotone: DriverRefreshTwotone,
};

export const DriverRefreshIcon = ({
  variant = "linear",
  ...props
}: IconProps) => {
