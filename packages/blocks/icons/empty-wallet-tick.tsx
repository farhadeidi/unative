...
const EmptyWalletTickBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const EmptyWalletTickBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: EmptyWalletTickBold,
  broken: EmptyWalletTickBroken,
  bulk: EmptyWalletTickBulk,
  linear: EmptyWalletTickLinear,
  outline: EmptyWalletTickOutline,
  twotone: EmptyWalletTickTwotone,
};

export const EmptyWalletTickIcon = ({
