...
const Building4Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Building4Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M2.09961 6.02002C2.09961 4.01002 3.09966 3 5.08966 3H11.3196C13.3096 3 14.2996 4.01002 14.2996 6.02002V22"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const Building4Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Building4Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Building4Outline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M19.7803 22.7598C19.3703 22.7598 19.0303 22.4198 19.0303 22.0098V17.5498C19.0303 17.1398 19.3703 16.7998 19.7803 16.7998C20.1903 16.7998 20.5303 17.1398 20.5303 17.5498V22.0098C20.5303 22.4198 20.2003 22.7598 19.7803 22.7598Z"
        fill="currentColor"
      />
      <Path
        d="M19.7996 18.2999C18.1696 18.2999 16.8496 16.9799 16.8496 15.3499V13.0799C16.8496 11.4499 18.1696 10.1299 19.7996 10.1299C21.4296 10.1299 22.7496 11.4499 22.7496 13.0799V15.3499C22.7496 16.9799 21.4296 18.2999 19.7996 18.2999ZM19.7996 11.6399C18.9996 11.6399 18.3496 12.2899 18.3496 13.0899V15.3599C18.3496 16.1599 18.9996 16.8099 19.7996 16.8099C20.5996 16.8099 21.2496 16.1599 21.2496 15.3599V13.0899C21.2496 12.2899 20.5996 11.6399 19.7996 11.6399Z"
        fill="currentColor"
      />
      <Path
        d="M14.2998 22.7498C13.8898 22.7498 13.5498 22.4098 13.5498 21.9998V6.02979C13.5498 4.43979 12.8798 3.75977 11.3198 3.75977H5.08984C3.51984 3.75977 2.83984 4.43979 2.83984 6.02979V21.9998C2.83984 22.4098 2.49984 22.7498 2.08984 22.7498C1.67984 22.7498 1.33984 22.4098 1.33984 21.9998V6.02979C1.33984 3.59979 2.66984 2.25977 5.08984 2.25977H11.3198C13.7298 2.25977 15.0498 3.59979 15.0498 6.02979V21.9998C15.0498 22.4098 14.7098 22.7498 14.2998 22.7498Z"
        fill="currentColor"
      />
      <Path
        d="M10.7498 9H5.7998C5.3898 9 5.0498 8.66 5.0498 8.25C5.0498 7.84 5.3898 7.5 5.7998 7.5H10.7498C11.1598 7.5 11.4998 7.84 11.4998 8.25C11.4998 8.66 11.1598 9 10.7498 9Z"
        fill="currentColor"
      />
      <Path
        d="M10.7498 12.75H5.7998C5.3898 12.75 5.0498 12.41 5.0498 12C5.0498 11.59 5.3898 11.25 5.7998 11.25H10.7498C11.1598 11.25 11.4998 11.59 11.4998 12C11.4998 12.41 11.1598 12.75 10.7498 12.75Z"
        fill="currentColor"
      />
      <Path
        d="M8.25 22.75C7.84 22.75 7.5 22.41 7.5 22V18.25C7.5 17.84 7.84 17.5 8.25 17.5C8.66 17.5 9 17.84 9 18.25V22C9 22.41 8.66 22.75 8.25 22.75Z"
...
const Building4Twotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: Building4Bold,
  broken: Building4Broken,
  bulk: Building4Bulk,
  linear: Building4Linear,
  outline: Building4Outline,
  twotone: Building4Twotone,
};

export const Building4Icon = ({ variant = "linear", ...props }: IconProps) => {
