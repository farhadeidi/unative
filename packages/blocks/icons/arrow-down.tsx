...
const ArrowDownBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowDownBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowDownBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowDownLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowDownOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowDownTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: ArrowDownBold,
  broken: ArrowDownBroken,
  bulk: ArrowDownBulk,
  linear: ArrowDownLinear,
  outline: ArrowDownOutline,
  twotone: ArrowDownTwotone,
};

export const ArrowDownIcon = ({ variant = "linear", ...props }: IconProps) => {
