...
const NotificationStatusBroken = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const NotificationStatusLinear = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const NotificationStatusOutline = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const NotificationStatusTwotone = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
...
const variants: IconVariants = {
  bold: NotificationStatusBold,
  broken: NotificationStatusBroken,
  bulk: NotificationStatusBulk,
  linear: NotificationStatusLinear,
  outline: NotificationStatusOutline,
  twotone: NotificationStatusTwotone,
};
