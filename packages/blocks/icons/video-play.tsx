...
const VideoPlayBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const VideoPlayBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const VideoPlayBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const VideoPlayLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const VideoPlayOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M8.51953 7.71986C8.10953 7.71986 7.76953 7.37986 7.76953 6.96986V2.10986C7.76953 1.69986 8.10953 1.35986 8.51953 1.35986C8.92953 1.35986 9.26953 1.69986 9.26953 2.10986V6.96986C9.26953 7.37986 8.92953 7.71986 8.51953 7.71986Z"
        fill="currentColor"
      />
      <Path
        d="M15.4805 7.26986C15.0705 7.26986 14.7305 6.92986 14.7305 6.51986V2.10986C14.7305 1.69986 15.0705 1.35986 15.4805 1.35986C15.8905 1.35986 16.2305 1.69986 16.2305 2.10986V6.51986C16.2305 6.93986 15.9005 7.26986 15.4805 7.26986Z"
        fill="currentColor"
      />
      <Path
        d="M11.09 18.1198C10.73 18.1198 10.39 18.0298 10.08 17.8598C9.4 17.4598 9 16.6598 9 15.6498V13.2498C9 12.2398 9.4 11.4298 10.09 11.0298C10.78 10.6298 11.68 10.6898 12.55 11.1998L14.63 12.3998C15.5 12.8998 16.01 13.6498 16.01 14.4498C16.01 15.2498 15.5 15.9998 14.62 16.4998L12.54 17.6998C12.06 17.9798 11.56 18.1198 11.09 18.1198ZM11.1 12.2698C11 12.2698 10.91 12.2898 10.84 12.3298C10.63 12.4498 10.5 12.7898 10.5 13.2498V15.6498C10.5 16.0998 10.63 16.4398 10.84 16.5698C11.05 16.6898 11.41 16.6298 11.8 16.3998L13.88 15.1998C14.27 14.9698 14.51 14.6898 14.51 14.4498C14.51 14.2098 14.28 13.9298 13.88 13.6998L11.8 12.4998C11.54 12.3498 11.29 12.2698 11.1 12.2698Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const VideoPlayTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: VideoPlayBold,
  broken: VideoPlayBroken,
  bulk: VideoPlayBulk,
  linear: VideoPlayLinear,
  outline: VideoPlayOutline,
  twotone: VideoPlayTwotone,
};

export const VideoPlayIcon = ({ variant = "linear", ...props }: IconProps) => {
