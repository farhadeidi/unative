...
const Frame3Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Frame3Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Frame3Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Frame3Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Frame3Outline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M10.7598 19.65C10.3498 19.65 10.0098 19.31 10.0098 18.9V12.1C10.0098 11.09 9.79977 10.75 8.52977 10.75H7.48977C6.21977 10.75 6.00977 11.09 6.00977 12.1V18.9C6.00977 19.31 5.66977 19.65 5.25977 19.65C4.84977 19.65 4.50977 19.31 4.50977 18.9V12.1C4.50977 10.18 5.48977 9.25 7.48977 9.25H8.52977C10.5398 9.25 11.5098 10.18 11.5098 12.1V18.9C11.5098 19.31 11.1698 19.65 10.7598 19.65Z"
        fill="currentColor"
      />
      <Path
        d="M22 19.75H2C1.59 19.75 1.25 19.41 1.25 19C1.25 18.59 1.58 18.25 2 18.25H22C22.41 18.25 22.75 18.59 22.75 19C22.75 19.41 22.42 19.75 22 19.75Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const Frame3Twotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  ...
  bulk: Frame3Bulk,
  linear: Frame3Linear,
  outline: Frame3Outline,
  twotone: Frame3Twotone,
};

export const Frame3Icon = ({ variant = "linear", ...props }: IconProps) => {
