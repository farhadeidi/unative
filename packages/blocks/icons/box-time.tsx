...
const BoxTimeBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BoxTimeBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BoxTimeBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BoxTimeLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BoxTimeOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BoxTimeTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: BoxTimeBold,
  broken: BoxTimeBroken,
  bulk: BoxTimeBulk,
  linear: BoxTimeLinear,
  outline: BoxTimeOutline,
  twotone: BoxTimeTwotone,
};

export const BoxTimeIcon = ({ variant = "linear", ...props }: IconProps) => {
