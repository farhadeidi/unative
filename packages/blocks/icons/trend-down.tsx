...
const TrendDownBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TrendDownBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M16.5 14.5L14.99 12.99L14 12"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const TrendDownBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TrendDownLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TrendDownOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M16.5002 15.2499C16.3102 15.2499 16.1202 15.1799 15.9702 15.0299L12.4202 11.4799L11.3302 13.1199C11.2102 13.3099 11.0002 13.4299 10.7802 13.4499C10.5502 13.4699 10.3302 13.3899 10.1802 13.2299L6.9802 10.0299C6.6902 9.73994 6.6902 9.25994 6.9802 8.96994C7.2702 8.67994 7.7502 8.67994 8.0402 8.96994L10.5902 11.5199L11.6802 9.87994C11.8002 9.69994 12.0002 9.57994 12.2302 9.54994C12.4602 9.52994 12.6802 9.60994 12.8302 9.76994L17.0302 13.9699C17.3202 14.2599 17.3202 14.7399 17.0302 15.0299C16.8802 15.1799 16.6902 15.2499 16.5002 15.2499Z"
        fill="currentColor"
      />
      <Path
...
const TrendDownTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: TrendDownBold,
  broken: TrendDownBroken,
  bulk: TrendDownBulk,
  linear: TrendDownLinear,
  outline: TrendDownOutline,
  twotone: TrendDownTwotone,
};

export const TrendDownIcon = ({ variant = "linear", ...props }: IconProps) => {
