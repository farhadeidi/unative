...
const ComputingBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ComputingBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M1.9707 13V15C1.9707 20 3.9707 22 8.9707 22H14.9707C19.9707 22 21.9707 20 21.9707 15V9C21.9707 4 19.9707 2 14.9707 2H8.9707C3.9707 2 1.9707 4 1.9707 9"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
const ComputingBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M20.9508 4.13005L4.13078 20.9501C3.71078 20.66 3.34078 20.2901 3.05078 19.8701L19.8708 3.05005C20.2908 3.34005 20.6608 3.71005 20.9508 4.13005Z"
        fill="currentColor"
      />
      <Path
...
const ComputingLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ComputingOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M3.27094 20.4499C3.08094 20.4499 2.89094 20.3799 2.74094 20.2299C2.45094 19.9399 2.45094 19.4599 2.74094 19.1699L19.1909 2.71994C19.4809 2.42994 19.9609 2.42994 20.2509 2.71994C20.5409 3.00994 20.5409 3.48994 20.2509 3.77994L3.80094 20.2299C3.66094 20.3799 3.47094 20.4499 3.27094 20.4499Z"
        fill="currentColor"
      />
      <Path
        d="M16.0605 18.75C15.6505 18.75 15.3105 18.41 15.3105 18V13C15.3105 12.59 15.6505 12.25 16.0605 12.25C16.4705 12.25 16.8105 12.59 16.8105 13V18C16.8105 18.41 16.4705 18.75 16.0605 18.75Z"
        fill="currentColor"
      />
      <Path
...
const ComputingTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: ComputingBold,
  broken: ComputingBroken,
  bulk: ComputingBulk,
  linear: ComputingLinear,
  outline: ComputingOutline,
  twotone: ComputingTwotone,
};

export const ComputingIcon = ({ variant = "linear", ...props }: IconProps) => {
