...
const Note2Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M13.5503 20.1619C13.2903 20.2719 13.0103 20.3719 12.7103 20.4719L11.1303 20.9919C7.16034 22.2719 5.07034 21.2019 3.78034 17.2319L2.50034 13.2819C1.22034 9.31187 2.28034 7.21187 6.25034 5.93187L7.79034 5.42188C7.60034 5.90187 7.44034 6.45188 7.29034 7.07188L6.31034 11.2619C5.21034 15.9719 6.82034 18.5719 11.5303 19.6919L13.2103 20.0919C13.3203 20.1219 13.4403 20.1419 13.5503 20.1619Z"
        fill="currentColor"
      />
      <Path
...
const Note2Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M20.9602 5.10001C22.0402 6.30001 22.2302 8.02001 21.6602 10.44L20.6802 14.62C19.8402 18.23 18.1802 19.69 15.0602 19.39C14.5602 19.35 14.0202 19.26 13.4402 19.12L11.7602 18.72C7.59018 17.73 6.30018 15.67 7.28018 11.49L8.26018 7.30001C8.46018 6.45001 8.70018 5.71001 9.00018 5.10001C10.1702 2.68001 12.1602 2.03001 15.5002 2.82001L17.1702 3.21001"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const Note2Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Note2Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Note2Outline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Note2Twotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  ...
  bulk: Note2Bulk,
  linear: Note2Linear,
  outline: Note2Outline,
  twotone: Note2Twotone,
};

export const Note2Icon = ({
