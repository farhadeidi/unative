...
const Maximize1Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Maximize1Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M18 12V10M16.95 12H18H16.95ZM6 12H12H14H6ZM6 12V10V12ZM6 12V14V12ZM18 12V14V12Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const Maximize1Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Maximize1Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Maximize1Outline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Maximize1Twotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: Maximize1Bold,
  broken: Maximize1Broken,
  bulk: Maximize1Bulk,
  linear: Maximize1Linear,
  outline: Maximize1Outline,
  twotone: Maximize1Twotone,
};

export const Maximize1Icon = ({ variant = "linear", ...props }: IconProps) => {
