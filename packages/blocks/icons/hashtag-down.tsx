...
const HashtagDownBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const HashtagDownBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M2 12.95V15C2 20 4 22 9 22H14"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
const HashtagDownBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const HashtagDownLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M22 13V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22H14"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const HashtagDownOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M14 22.75H9C3.57 22.75 1.25 20.43 1.25 15V9C1.25 3.57 3.57 1.25 9 1.25H15C20.43 1.25 22.75 3.57 22.75 9V13C22.75 13.41 22.41 13.75 22 13.75C21.59 13.75 21.25 13.41 21.25 13V9C21.25 4.39 19.61 2.75 15 2.75H9C4.39 2.75 2.75 4.39 2.75 9V15C2.75 19.61 4.39 21.25 9 21.25H14C14.41 21.25 14.75 21.59 14.75 22C14.75 22.41 14.41 22.75 14 22.75Z"
        fill="currentColor"
      />
      <Path
        d="M19 22.75C18.9 22.75 18.81 22.73 18.71 22.69C18.43 22.57 18.25 22.3 18.25 22V16C18.25 15.59 18.59 15.25 19 15.25C19.41 15.25 19.75 15.59 19.75 16V20.19L20.47 19.47C20.76 19.18 21.24 19.18 21.53 19.47C21.82 19.76 21.82 20.24 21.53 20.53L19.53 22.53C19.39 22.67 19.19 22.75 19 22.75Z"
        fill="currentColor"
      />
      <Path
        d="M18.9995 22.7499C18.8095 22.7499 18.6195 22.6799 18.4695 22.5299L16.4695 20.5299C16.1795 20.2399 16.1795 19.7599 16.4695 19.4699C16.7595 19.1799 17.2395 19.1799 17.5295 19.4699L19.5295 21.4699C19.8195 21.7599 19.8195 22.2399 19.5295 22.5299C19.3795 22.6799 19.1895 22.7499 18.9995 22.7499Z"
        fill="currentColor"
      />
      <Path
        d="M8.89974 16.4901C8.86974 16.4901 8.83974 16.4901 8.81974 16.4901C8.40974 16.4401 8.10974 16.0701 8.15974 15.6601L9.19974 6.1801C9.24974 5.7701 9.60974 5.4701 10.0297 5.5201C10.4397 5.5701 10.7397 5.9401 10.6897 6.3501L9.63975 15.8201C9.59975 16.2001 9.26974 16.4901 8.89974 16.4901Z"
        fill="currentColor"
      />
      <Path
...
const HashtagDownTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: HashtagDownBold,
  broken: HashtagDownBroken,
  bulk: HashtagDownBulk,
  linear: HashtagDownLinear,
  outline: HashtagDownOutline,
  twotone: HashtagDownTwotone,
};

export const HashtagDownIcon = ({
  variant = "linear",
  className,
  ...props
}: IconProps) => {
