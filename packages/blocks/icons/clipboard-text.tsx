...
const ClipboardTextBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ClipboardTextBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ClipboardTextBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ClipboardTextLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  ...
  broken: ClipboardTextBroken,
  bulk: ClipboardTextBulk,
  linear: ClipboardTextLinear,
  outline: ClipboardTextOutline,
  twotone: ClipboardTextTwotone,
};
