...
const DocumentCopyBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DocumentCopyBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M17 13.3999V16.3999C17 20.3999 15.4 21.9999 11.4 21.9999H7.6C3.6 21.9999 2 20.3999 2 16.3999"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M13.7996 13.4C11.3996 13.4 10.5996 12.6 10.5996 10.2V7L16.9996 13.4"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const DocumentCopyBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DocumentCopyLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DocumentCopyOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DocumentCopyTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M15.9996 12.4H12.7996C10.3996 12.4 9.59961 11.6 9.59961 9.2V6L15.9996 12.4Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <Path
        opacity="0.4"
        d="M20.9995 7V13.19C20.9995 14.74 19.7395 16 18.1895 16"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M21 7H18C15.75 7 15 6.25 15 4V1L21 7Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const variants: IconVariants = {
  bold: DocumentCopyBold,
  broken: DocumentCopyBroken,
  bulk: DocumentCopyBulk,
  linear: DocumentCopyLinear,
  outline: DocumentCopyOutline,
  twotone: DocumentCopyTwotone,
};
