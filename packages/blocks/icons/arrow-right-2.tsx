...
const ArrowRight2Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowRight2Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowRight2Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowRight2Outline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M12.4995 15.7499C12.3095 15.7499 12.1195 15.6799 11.9695 15.5299C11.6795 15.2399 11.6795 14.7599 11.9695 14.4699L14.4395 11.9999L11.9695 9.52994C11.6795 9.23994 11.6795 8.75994 11.9695 8.46994C12.2595 8.17994 12.7395 8.17994 13.0295 8.46994L16.0295 11.4699C16.3195 11.7599 16.3195 12.2399 16.0295 12.5299L13.0295 15.5299C12.8795 15.6799 12.6895 15.7499 12.4995 15.7499Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const ArrowRight2Twotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: ArrowRight2Bold,
  broken: ArrowRight2Broken,
  bulk: ArrowRight2Bulk,
  linear: ArrowRight2Linear,
  outline: ArrowRight2Outline,
  twotone: ArrowRight2Twotone,
};
