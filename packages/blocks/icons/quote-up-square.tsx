...
const QuoteUpSquareBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const QuoteUpSquareBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M10.8602 11.84H8.18023C7.47023 11.84 6.99023 11.3 6.99023 10.65V9.15997C6.99023 8.50997 7.47023 7.96997 8.18023 7.96997H9.67023C10.3202 7.96997 10.8602 8.50997 10.8602 9.15997V11.84Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const QuoteUpSquareBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        opacity="0.4"
        d="M16.1898 2H7.81977C4.17977 2 2.00977 4.17 2.00977 7.81V16.18C2.00977 19.82 4.17977 21.99 7.81977 21.99H16.1898C19.8298 21.99 21.9998 19.82 21.9998 16.18V7.81C21.9998 4.17 19.8298 2 16.1898 2Z"
        fill="currentColor"
      />
      <Path
...
const QuoteUpSquareLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
  ...
  return (
    ...
    >
      ...
      <G opacity="0.4">
        ...
        />
        <Path
          d="M10.8602 11.8398H8.18023C7.47023 11.8398 6.99023 11.2998 6.99023 10.6498V9.15973C6.99023 8.50973 7.47023 7.96973 8.18023 7.96973H9.67023C10.3202 7.96973 10.8602 8.50973 10.8602 9.15973V11.8398Z"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
...
const variants: IconVariants = {
  bold: QuoteUpSquareBold,
  broken: QuoteUpSquareBroken,
  bulk: QuoteUpSquareBulk,
  linear: QuoteUpSquareLinear,
  outline: QuoteUpSquareOutline,
  twotone: QuoteUpSquareTwotone,
};

export const QuoteUpSquareIcon = ({
  variant = "linear",
  className,
  ...props
}: IconProps) => {
