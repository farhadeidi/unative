...
const Buildings2Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Buildings2Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M6.70001 18.0001H4.15002C2.72002 18.0001 2 17.28 2 15.85V8.04004"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const Buildings2Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M12.75 19V22H11.25V19C11.25 18.59 11.59 18.25 12 18.25C12.41 18.25 12.75 18.59 12.75 19Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const Buildings2Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Buildings2Outline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Buildings2Twotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: Buildings2Bold,
  broken: Buildings2Broken,
  bulk: Buildings2Bulk,
  linear: Buildings2Linear,
  outline: Buildings2Outline,
  twotone: Buildings2Twotone,
};

export const Buildings2Icon = ({ variant = "linear", ...props }: IconProps) => {
