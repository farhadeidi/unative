...
const PlayRemoveBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const PlayRemoveBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M20.0692 20.0399L17.9492 17.9299"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M20.0497 17.96L17.9297 20.0699"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const PlayRemoveBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const PlayRemoveLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M20.0699 20.0399L17.95 17.9299"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M20.0499 17.96L17.9299 20.0699"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const PlayRemoveOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M12 22.75C6.07 22.75 1.25 17.93 1.25 12C1.25 6.07 6.07 1.25 12 1.25C17.93 1.25 22.75 6.07 22.75 12C22.75 13.4 22.49 14.74 21.97 16C21.88 16.21 21.71 16.37 21.49 16.43C21.27 16.5 21.04 16.46 20.85 16.33C19.67 15.52 18.07 15.58 16.96 16.46C16.19 17.07 15.74 18 15.74 18.99C15.74 19.58 15.9 20.16 16.21 20.66C16.24 20.71 16.26 20.74 16.29 20.77C16.45 20.95 16.51 21.2 16.46 21.44C16.41 21.68 16.24 21.87 16.01 21.96C14.74 22.49 13.39 22.75 12 22.75ZM12 2.75C6.9 2.75 2.75 6.9 2.75 12C2.75 17.1 6.9 21.25 12 21.25C12.9 21.25 13.78 21.12 14.63 20.86C14.38 20.28 14.25 19.65 14.25 19C14.25 17.54 14.9 16.19 16.03 15.29C17.38 14.21 19.3 13.96 20.86 14.63C21.11 13.79 21.24 12.9 21.24 11.99C21.25 6.89999 17.1 2.75 12 2.75Z"
        fill="currentColor"
      />
      <Path
      ...
      />
      <Path
        d="M19 23.75C17.43 23.75 15.98 22.98 15.11 21.69C15.07 21.66 14.99 21.54 14.93 21.43C14.49 20.72 14.25 19.87 14.25 19C14.25 17.54 14.9 16.19 16.03 15.29C17.64 14.01 20.01 13.92 21.7 15.1C22.98 15.99 23.74 17.44 23.74 19C23.74 19.87 23.5 20.7201 23.05 21.4501C22.8 21.8701 22.48 22.25 22.1 22.57C21.28 23.33 20.17 23.75 19 23.75ZM19 15.75C18.26 15.75 17.56 16 16.97 16.47C16.2 17.08 15.75 18.01 15.75 19C15.75 19.59 15.91 20.17 16.22 20.67C16.25 20.72 16.27 20.7501 16.3 20.7801C16.95 21.7301 17.94 22.25 19.01 22.25C19.8 22.25 20.56 21.96 21.14 21.44C21.4 21.22 21.62 20.96 21.78 20.68C22.1 20.17 22.26 19.59 22.26 19C22.26 17.94 21.74 16.9401 20.86 16.3401C20.3 15.9501 19.66 15.75 19 15.75Z"
        fill="currentColor"
      />
      <Path
        d="M20.0704 20.7901C19.8804 20.7901 19.6904 20.7201 19.5404 20.5701L17.4304 18.4601C17.1404 18.1701 17.1404 17.6901 17.4304 17.4001C17.7204 17.1101 18.2004 17.1101 18.4904 17.4001L20.6004 19.5101C20.8904 19.8001 20.8904 20.2801 20.6004 20.5701C20.4504 20.7201 20.2604 20.7901 20.0704 20.7901Z"
        fill="currentColor"
      />
      <Path
        d="M17.9311 20.8199C17.7411 20.8199 17.5511 20.7499 17.4011 20.5999C17.1111 20.3099 17.1111 19.8299 17.4011 19.5399L19.5111 17.4299C19.8011 17.1399 20.2811 17.1399 20.5711 17.4299C20.8611 17.7199 20.8611 18.1999 20.5711 18.4899L18.4611 20.5999C18.3111 20.7499 18.1211 20.8199 17.9311 20.8199Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const PlayRemoveTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      <G opacity="0.4">
        <Path
          d="M20.0692 20.0402L17.9492 17.9302"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeMiterlimit="10"
          strokeLinecap="round"
...
const variants: IconVariants = {
  bold: PlayRemoveBold,
  broken: PlayRemoveBroken,
  bulk: PlayRemoveBulk,
  linear: PlayRemoveLinear,
  outline: PlayRemoveOutline,
  twotone: PlayRemoveTwotone,
};

export const PlayRemoveIcon = ({ variant = "linear", ...props }: IconProps) => {
