...
const TextBlockBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TextBlockBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TextBlockBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TextBlockLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TextBlockOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M7.00051 9.63002C6.73051 9.63002 6.46051 9.48002 6.33051 9.22002C6.14051 8.85002 6.29051 8.40002 6.66051 8.21002C10.0005 6.54002 13.9905 6.54002 17.3305 8.21002C17.7005 8.40002 17.8505 8.85002 17.6705 9.22002C17.4805 9.59002 17.0405 9.74002 16.6605 9.56002C13.7405 8.10002 10.2505 8.10002 7.33051 9.56002C7.23051 9.61002 7.11051 9.63002 7.00051 9.63002Z"
        fill="currentColor"
      />
      <Path
        d="M12 17.0402C11.59 17.0402 11.25 16.7002 11.25 16.2902V7.93018C11.25 7.52018 11.59 7.18018 12 7.18018C12.41 7.18018 12.75 7.52018 12.75 7.93018V16.3002C12.75 16.7102 12.41 17.0402 12 17.0402Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const TextBlockTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: TextBlockBold,
  broken: TextBlockBroken,
  bulk: TextBlockBulk,
  linear: TextBlockLinear,
  outline: TextBlockOutline,
  twotone: TextBlockTwotone,
};

export const TextBlockIcon = ({ variant = "linear", ...props }: IconProps) => {
