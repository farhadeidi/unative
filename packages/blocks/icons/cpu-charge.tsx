...
const CpuChargeBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CpuChargeBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M12.0007 9.69995L11.0607 11.34C10.8507 11.7 11.0207 12 11.4407 12H12.5607C12.9807 12 13.1507 12.3 12.9407 12.66L12.0007 14.3"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const CpuChargeBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CpuChargeLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CpuChargeOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M11.9996 15.05C11.8696 15.05 11.7396 15.02 11.6296 14.95C11.2696 14.74 11.1496 14.28 11.3496 13.93L12.0296 12.75H11.4396C10.9596 12.75 10.5696 12.54 10.3596 12.18C10.1496 11.82 10.1696 11.37 10.3996 10.96L11.3396 9.31995C11.5496 8.95995 12.0096 8.83995 12.3596 9.03995C12.7196 9.24995 12.8396 9.70995 12.6396 10.06L11.9596 11.24H12.5496C13.0296 11.24 13.4196 11.45 13.6296 11.81C13.8396 12.17 13.8196 12.62 13.5896 13.03L12.6496 14.67C12.5096 14.92 12.2596 15.05 11.9996 15.05Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const CpuChargeTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: CpuChargeBold,
  broken: CpuChargeBroken,
  bulk: CpuChargeBulk,
  linear: CpuChargeLinear,
  outline: CpuChargeOutline,
  twotone: CpuChargeTwotone,
};

export const CpuChargeIcon = ({ variant = "linear", ...props }: IconProps) => {
