...
const ArchiveBoxBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArchiveBoxBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArchiveBoxBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArchiveBoxLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArchiveBoxOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArchiveBoxTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: ArchiveBoxBold,
  broken: ArchiveBoxBroken,
  bulk: ArchiveBoxBulk,
  linear: ArchiveBoxLinear,
  outline: ArchiveBoxOutline,
  twotone: ArchiveBoxTwotone,
};

export const ArchiveBoxIcon = ({ variant = "linear", ...props }: IconProps) => {
