...
const DocumentText1Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DocumentText1Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DocumentText1Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DocumentText1Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: DocumentText1Bold,
  broken: DocumentText1Broken,
  bulk: DocumentText1Bulk,
  linear: DocumentText1Linear,
  outline: DocumentText1Outline,
  twotone: DocumentText1Twotone,
};
