...
const LayerBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const LayerBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M18.9193 5.54007C20.6193 6.29007 20.6193 7.53007 18.9193 8.28007L13.0193 10.9001C12.3493 11.2001 11.2493 11.2001 10.5793 10.9001L4.6793 8.28007C2.9793 7.53007 2.9793 6.29007 4.6793 5.54007L10.5793 2.92007C11.2493 2.62007 12.3493 2.62007 13.0193 2.92007L14.9393 3.77007"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
const LayerBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const LayerLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const LayerOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const LayerTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M13.0095 2.91982L18.9095 5.53982C20.6095 6.28982 20.6095 7.52982 18.9095 8.27982L13.0095 10.8998C12.3395 11.1998 11.2395 11.1998 10.5695 10.8998L4.66953 8.27982C2.96953 7.52982 2.96953 6.28982 4.66953 5.53982L10.5695 2.91982C11.2395 2.61982 12.3395 2.61982 13.0095 2.91982Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const variants: IconVariants = {
  ...
  twotone: LayerTwotone,
};

export const LayerIcon = ({ variant = "linear", ...props }: IconProps) => {
