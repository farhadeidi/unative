...
const TruckTickBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TruckTickBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M20.2905 9H19.0005C18.4505 9 18.0005 9.45 18.0005 10V13C18.0005 13.55 18.4505 14 19.0005 14H22.0005V17C22.0005 18.66 20.6605 20 19.0005 20H18.0005C18.0005 18.9 17.1005 18 16.0005 18C14.9005 18 14.0005 18.9 14.0005 20H10.0005C10.0005 18.9 9.10049 18 8.00049 18C6.90049 18 6.00049 18.9 6.00049 20H5.00049C3.94049 20 3.01047 19.45 2.48047 18.63"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M2 14H13C14.1 14 15 13.1 15 12V5H16.84C17.2 5 17.55 5.10002 17.85 5.27002"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <Path
        d="M8.9992 4.90999C9.0192 5.65999 8.81922 6.38001 8.45922 6.99001C8.25922 7.35001 7.9992 7.68002 7.6892 7.94002C7.0092 8.59002 6.09922 8.98002 5.08922 9.00002C3.84922 9.03002 2.7292 8.49001 1.9992 7.62001C1.8592 7.47001 1.7392 7.30002 1.6292 7.13002C1.2392 6.54002 1.0192 5.84005 0.999195 5.09005C0.969195 3.83005 1.52919 2.68001 2.42919 1.93001C3.10919 1.37001 3.96917 1.02002 4.90917 1.00002C5.95917 0.98002 6.91921 1.36002 7.63921 2.00002C8.44921 2.71002 8.9692 3.73999 8.9992 4.90999Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M3.43945 5.03003L4.44946 5.98999L6.53943 3.96997"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const TruckTickBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TruckTickLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M3.43994 5.03003L4.44995 5.98999L6.53992 3.96997"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const TruckTickOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M4.4489 6.74993C4.2589 6.74993 4.07888 6.6799 3.92888 6.5399L2.91887 5.57994C2.61887 5.28994 2.60891 4.81995 2.89891 4.51995C3.18891 4.21995 3.65891 4.20993 3.95891 4.49993L4.4489 4.9699L6.01891 3.44994C6.31891 3.15994 6.78891 3.1699 7.07891 3.4699C7.36891 3.7699 7.35889 4.23996 7.05889 4.52996L4.96886 6.54991C4.81886 6.67991 4.6289 6.74993 4.4489 6.74993Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const TruckTickTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M8.9992 4.90975C9.0192 5.65975 8.81922 6.37977 8.45922 6.98977C8.25922 7.34977 7.9992 7.67978 7.6892 7.93978C7.0092 8.58978 6.09922 8.97978 5.08922 8.99978C3.84922 9.02978 2.7292 8.48977 1.9992 7.61977C1.8592 7.46977 1.7392 7.29978 1.6292 7.12978C1.2392 6.53978 1.0192 5.8398 0.999195 5.0898C0.969195 3.8298 1.52919 2.67977 2.42919 1.92977C3.10919 1.36977 3.96917 1.01978 4.90917 0.999776C5.95917 0.979776 6.91921 1.35978 7.63921 1.99978C8.44921 2.70978 8.9692 3.73975 8.9992 4.90975Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
      ...
      <Path
        opacity="0.4"
        d="M3.43945 5.02979L4.44946 5.98975L6.53943 3.96973"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const variants: IconVariants = {
  bold: TruckTickBold,
  broken: TruckTickBroken,
  bulk: TruckTickBulk,
  linear: TruckTickLinear,
  outline: TruckTickOutline,
  twotone: TruckTickTwotone,
};

export const TruckTickIcon = ({ variant = "linear", ...props }: IconProps) => {
