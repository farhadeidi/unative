...
const DirectBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DirectBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DirectBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M13.55 7.7999H10.45C10.06 7.7999 9.75 7.4899 9.75 7.0999C9.75 6.7099 10.06 6.3999 10.45 6.3999H13.55C13.94 6.3999 14.25 6.7099 14.25 7.0999C14.25 7.4899 13.93 7.7999 13.55 7.7999Z"
        fill="currentColor"
      />
      <Path
        d="M14.3307 10.5899H9.6707C9.2807 10.5899 8.9707 10.2799 8.9707 9.88994C8.9707 9.49994 9.2807 9.18994 9.6707 9.18994H14.3207C14.7107 9.18994 15.0207 9.49994 15.0207 9.88994C15.0207 10.2799 14.7107 10.5899 14.3307 10.5899Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const DirectLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DirectOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DirectTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  ...
  bulk: DirectBulk,
  linear: DirectLinear,
  outline: DirectOutline,
  twotone: DirectTwotone,
};

export const DirectIcon = ({ variant = "linear", ...props }: IconProps) => {
