...
const CloudDrizzleBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CloudDrizzleBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CloudDrizzleBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CloudDrizzleLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CloudDrizzleOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M7.97016 22.7499C7.78016 22.7499 7.59016 22.6799 7.44016 22.5299C7.15016 22.2399 7.15016 21.7599 7.44016 21.4699L9.44016 19.4699C9.73016 19.1799 10.2102 19.1799 10.5002 19.4699C10.7902 19.7599 10.7902 20.2399 10.5002 20.5299L8.50016 22.5299C8.36016 22.6799 8.17016 22.7499 7.97016 22.7499Z"
        fill="currentColor"
      />
      <Path
        d="M11.9702 22.7499C11.7802 22.7499 11.5902 22.6799 11.4402 22.5299C11.1502 22.2399 11.1502 21.7599 11.4402 21.4699L13.4402 19.4699C13.7302 19.1799 14.2102 19.1799 14.5002 19.4699C14.7902 19.7599 14.7902 20.2399 14.5002 20.5299L12.5002 22.5299C12.3602 22.6799 12.1702 22.7499 11.9702 22.7499Z"
        fill="currentColor"
      />
      <Path
        d="M11.9702 18.7499C11.7802 18.7499 11.5902 18.6799 11.4402 18.5299C11.1502 18.2399 11.1502 17.7599 11.4402 17.4699L13.4402 15.4699C13.7302 15.1799 14.2102 15.1799 14.5002 15.4699C14.7902 15.7599 14.7902 16.2399 14.5002 16.5299L12.5002 18.5299C12.3602 18.6799 12.1702 18.7499 11.9702 18.7499Z"
        fill="currentColor"
      />
      <Path
        d="M7.97016 18.7499C7.78016 18.7499 7.59016 18.6799 7.44016 18.5299C7.15016 18.2399 7.15016 17.7599 7.44016 17.4699L9.44016 15.4699C9.73016 15.1799 10.2102 15.1799 10.5002 15.4699C10.7902 15.7599 10.7902 16.2399 10.5002 16.5299L8.50016 18.5299C8.36016 18.6799 8.17016 18.7499 7.97016 18.7499Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const CloudDrizzleTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: CloudDrizzleBold,
  broken: CloudDrizzleBroken,
  bulk: CloudDrizzleBulk,
  linear: CloudDrizzleLinear,
  outline: CloudDrizzleOutline,
  twotone: CloudDrizzleTwotone,
};
