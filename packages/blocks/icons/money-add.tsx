...
const MoneyAddBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyAddBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyAddBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyAddLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyAddOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M6.49976 18.73H3.50977C3.09977 18.73 2.75977 18.39 2.75977 17.98C2.75977 17.57 3.09977 17.23 3.50977 17.23H6.49976C6.90976 17.23 7.24976 17.57 7.24976 17.98C7.24976 18.39 6.90976 18.73 6.49976 18.73Z"
        fill="currentColor"
      />
      <Path
        d="M5 20.26C4.59 20.26 4.25 19.92 4.25 19.51V16.52C4.25 16.11 4.59 15.77 5 15.77C5.41 15.77 5.75 16.11 5.75 16.52V19.51C5.75 19.93 5.41 20.26 5 20.26Z"
        fill="currentColor"
      />
      <Path
...
const MoneyAddTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: MoneyAddBold,
  broken: MoneyAddBroken,
  bulk: MoneyAddBulk,
  linear: MoneyAddLinear,
  outline: MoneyAddOutline,
  twotone: MoneyAddTwotone,
};

export const MoneyAddIcon = ({ variant = "linear", ...props }: IconProps) => {
