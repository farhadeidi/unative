...
const ReceiptMinusBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M7 2H6C3 2 2 3.79 2 6V7V21C2 21.83 2.94 22.3 3.6 21.8L5.31 20.52C5.71 20.22 6.27 20.26 6.63 20.62L8.29 22.29C8.68 22.68 9.32 22.68 9.71 22.29L11.39 20.61C11.74 20.26 12.3 20.22 12.69 20.52L14.4 21.8C15.06 22.29 16 21.82 16 21V4C16 2.9 16.9 2 18 2H7ZM11.75 10.75H6.25C5.84 10.75 5.5 10.41 5.5 10C5.5 9.59 5.84 9.25 6.25 9.25H11.75C12.16 9.25 12.5 9.59 12.5 10C12.5 10.41 12.16 10.75 11.75 10.75Z"
        fill="currentColor"
      />
      <Path
...
const ReceiptMinusBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ReceiptMinusBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ReceiptMinusLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ReceiptMinusOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M8.99976 23.33C8.52976 23.33 8.08977 23.15 7.75977 22.81L6.09976 21.14C6.00976 21.05 5.86976 21.04 5.76976 21.12L4.05976 22.4C3.52976 22.8 2.82977 22.87 2.22977 22.57C1.62977 22.27 1.25977 21.67 1.25977 21V6C1.25977 2.98 2.98977 1.25 6.00977 1.25H18.0098C18.4198 1.25 18.7598 1.59 18.7598 2C18.7598 2.41 18.4198 2.75 18.0098 2.75C17.3198 2.75 16.7598 3.31 16.7598 4V21C16.7598 21.67 16.3898 22.27 15.7898 22.57C15.1898 22.87 14.4898 22.81 13.9598 22.41L12.2498 21.13C12.1498 21.05 12.0098 21.07 11.9298 21.15L10.2498 22.83C9.90976 23.15 9.46976 23.33 8.99976 23.33ZM5.90977 19.57C6.36977 19.57 6.81977 19.74 7.15977 20.09L8.81976 21.76C8.87976 21.82 8.95976 21.83 8.99976 21.83C8.98976 21.81 9.11976 21.82 9.17976 21.76L10.8598 20.08C11.4798 19.46 12.4598 19.4 13.1498 19.93L14.8498 21.2C14.9598 21.28 15.0598 21.25 15.1098 21.22C15.1598 21.19 15.2498 21.13 15.2498 21V4C15.2498 3.55 15.3598 3.12 15.5498 2.75H5.99976C3.77976 2.75 2.74976 3.78 2.74976 6V21C2.74976 21.14 2.83976 21.2 2.88976 21.23C2.94976 21.26 3.04976 21.28 3.14977 21.2L4.85976 19.92C5.16976 19.69 5.53977 19.57 5.90977 19.57Z"
        fill="currentColor"
      />
      <Path
        d="M11.75 10.75H6.25C5.84 10.75 5.5 10.41 5.5 10C5.5 9.59 5.84 9.25 6.25 9.25H11.75C12.16 9.25 12.5 9.59 12.5 10C12.5 10.41 12.16 10.75 11.75 10.75Z"
...
const ReceiptMinusTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: ReceiptMinusBold,
  broken: ReceiptMinusBroken,
  bulk: ReceiptMinusBulk,
  linear: ReceiptMinusLinear,
  outline: ReceiptMinusOutline,
  twotone: ReceiptMinusTwotone,
};
