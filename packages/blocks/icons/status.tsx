...
const StatusBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const StatusBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M2.44922 14.97C3.51922 18.41 6.39923 21.06 9.97923 21.79"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const StatusBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const StatusLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const StatusOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M9.9898 22.5501C9.9398 22.5501 9.8898 22.5501 9.8398 22.5301C6.0098 21.7501 2.8998 18.9301 1.7398 15.1901C1.6198 14.7901 1.8398 14.3701 2.2298 14.2501C2.6298 14.1301 3.0498 14.3501 3.1698 14.7401C4.1698 17.9601 6.8398 20.3801 10.1398 21.0501C10.5498 21.1301 10.8098 21.5301 10.7198 21.9401C10.6498 22.3001 10.3298 22.5501 9.9898 22.5501Z"
        fill="currentColor"
      />
      <Path
...
const StatusTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  ...
  twotone: StatusTwotone,
};

export const StatusIcon = ({ variant = "linear", ...props }: IconProps) => {
