...
const Export3Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Export3Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M17.52 18.01C16.16 19.25 14.29 20 12 20C7 20 4 16.42 4 12"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M19.9998 12C19.9998 13.05 19.8298 14.05 19.5098 14.97"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M9.43945 6.46991L11.9995 3.90991L14.5595 6.46991"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const Export3Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Export3Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Export3Outline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const Export3Twotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: Export3Bold,
  broken: Export3Broken,
  bulk: Export3Bulk,
  linear: Export3Linear,
  outline: Export3Outline,
  twotone: Export3Twotone,
};
