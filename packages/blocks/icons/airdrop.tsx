...
const AirdropBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const AirdropBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M12.5495 12.9201C10.9095 13.3101 9.4795 11.8801 9.8695 10.2401C10.0595 9.47008 10.6895 8.84011 11.4595 8.65011C12.8095 8.32011 14.0295 9.25009 14.1895 10.5001"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M7.64093 3.1499C4.99093 4.6599 3.21094 7.51986 3.21094 10.7899C3.21094 13.3299 4.29094 15.6198 6.02094 17.2198"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M18.01 17.19C19.72 15.59 20.79 13.32 20.79 10.79C20.79 5.92998 16.85 2 12 2"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <Path
        d="M10.3007 16.66L8.86071 18.4501C7.72071 19.8801 8.73071 21.99 10.5607 21.99H13.4307C15.2607 21.99 16.2807 19.8701 15.1307 18.4501L13.6907 16.66C12.8307 15.57 11.1707 15.57 10.3007 16.66Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const AirdropBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const AirdropLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const AirdropOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const AirdropTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      <Path
        opacity="0.4"
        d="M7.99977 14.5498C7.07977 13.5698 6.50977 12.2498 6.50977 10.7898C6.50977 7.75979 8.96977 5.2998 11.9998 5.2998C15.0298 5.2998 17.4898 7.75979 17.4898 10.7898C17.4898 12.2498 16.9198 13.5598 15.9998 14.5498"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <Path
        opacity="0.4"
        d="M10.2997 16.6598L8.85973 18.4498C7.71973 19.8798 8.72973 21.9898 10.5597 21.9898H13.4297C15.2597 21.9898 16.2797 19.8698 15.1297 18.4498L13.6897 16.6598C12.8297 15.5698 11.1697 15.5698 10.2997 16.6598Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const variants: IconVariants = {
  bold: AirdropBold,
  broken: AirdropBroken,
  bulk: AirdropBulk,
  linear: AirdropLinear,
  outline: AirdropOutline,
  twotone: AirdropTwotone,
};

export const AirdropIcon = ({ variant = "linear", ...props }: IconProps) => {
