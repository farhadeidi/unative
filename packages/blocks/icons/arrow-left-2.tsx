...
const ArrowLeft2Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowLeft2Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M15.0908 4.04004L14.0508 5.08004"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const ArrowLeft2Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowLeft2Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowLeft2Outline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ArrowLeft2Twotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: ArrowLeft2Bold,
  broken: ArrowLeft2Broken,
  bulk: ArrowLeft2Bulk,
  linear: ArrowLeft2Linear,
  outline: ArrowLeft2Outline,
  twotone: ArrowLeft2Twotone,
};

export const ArrowLeft2Icon = ({ variant = "linear", ...props }: IconProps) => {
