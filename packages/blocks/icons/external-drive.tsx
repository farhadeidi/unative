...
const ExternalDriveBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ExternalDriveBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M4 7C4 4 6 2 9 2H16C19 2 21 4 21 7V17C21 20 19 22 16 22H9C6 22 4 20 4 17V11.71"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
const ExternalDriveBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ExternalDriveLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: ExternalDriveBold,
  broken: ExternalDriveBroken,
  bulk: ExternalDriveBulk,
  linear: ExternalDriveLinear,
  outline: ExternalDriveOutline,
  twotone: ExternalDriveTwotone,
};
