...
const AdditemBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const AdditemBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M2 5.43C2 3.14 3.14 2 5.43 2H10C12.29 2 13.43 3.14 13.43 5.43"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M8 16H5.43C3.14 16 2 14.86 2 12.57V9.97998"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const AdditemBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const AdditemLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const AdditemOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M18.5703 22.75H14.0003C11.3103 22.75 9.82031 21.27 9.82031 18.57V11.43C9.82031 8.74 11.3003 7.25 14.0003 7.25H18.5703C21.2603 7.25 22.7503 8.73 22.7503 11.43V18.57C22.7503 21.27 21.2703 22.75 18.5703 22.75ZM14.0003 8.75C12.1203 8.75 11.3203 9.55 11.3203 11.43V18.57C11.3203 20.45 12.1203 21.25 14.0003 21.25H18.5703C20.4503 21.25 21.2503 20.45 21.2503 18.57V11.43C21.2503 9.55 20.4503 8.75 18.5703 8.75H14.0003Z"
        fill="currentColor"
      />
      <Path
        d="M18.1309 15.75H14.8809C14.4709 15.75 14.1309 15.41 14.1309 15C14.1309 14.59 14.4709 14.25 14.8809 14.25H18.1309C18.5409 14.25 18.8809 14.59 18.8809 15C18.8809 15.41 18.5409 15.75 18.1309 15.75Z"
        fill="currentColor"
      />
      <Path
...
const AdditemTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: AdditemBold,
  broken: AdditemBroken,
  bulk: AdditemBulk,
  linear: AdditemLinear,
  outline: AdditemOutline,
  twotone: AdditemTwotone,
};

export const AdditemIcon = ({ variant = "linear", ...props }: IconProps) => {
