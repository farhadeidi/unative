...
const WalletBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M21.4499 13.6406V14.6406C21.4499 14.9106 21.2399 15.1306 20.9599 15.1406H19.4999C18.9699 15.1406 18.4899 14.7506 18.4499 14.2306C18.4199 13.9206 18.5399 13.6306 18.7399 13.4306C18.9199 13.2406 19.1699 13.1406 19.4399 13.1406H20.9499C21.2399 13.1506 21.4499 13.3706 21.4499 13.6406Z"
        fill="currentColor"
      />
      <Path
        d="M17.9892 12.6906C17.4892 13.1806 17.2492 13.9106 17.4492 14.6706C17.7092 15.6006 18.6192 16.1906 19.5792 16.1906H20.4492C20.9992 16.1906 21.4492 16.6406 21.4492 17.1906V17.3806C21.4492 19.4506 19.7592 21.1406 17.6892 21.1406H6.20922C4.13922 21.1406 2.44922 19.4506 2.44922 17.3806V10.6506C2.44922 9.42062 3.03922 8.33063 3.94922 7.65063C4.57922 7.17063 5.35922 6.89062 6.20922 6.89062H17.6892C19.7592 6.89062 21.4492 8.58062 21.4492 10.6506V11.0906C21.4492 11.6406 20.9992 12.0906 20.4492 12.0906H19.4292C18.8692 12.0906 18.3592 12.3106 17.9892 12.6906Z"
        fill="currentColor"
      />
      <Path
...
const WalletBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const WalletBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const WalletLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const WalletOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const WalletTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  ...
  twotone: WalletTwotone,
};

export const WalletIcon = ({ variant = "linear", ...props }: IconProps) => {
