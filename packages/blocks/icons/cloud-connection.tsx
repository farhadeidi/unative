...
const CloudConnectionBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M19.2007 14.7811C18.3407 15.5711 17.2007 16.0111 16.0307 16.0011H6.3707C2.3007 15.7111 2.2907 9.80114 6.3707 9.51114H6.4107C3.6207 1.75114 15.4107 -1.33886 16.7607 6.80114C20.5307 7.28114 22.0607 12.2911 19.2007 14.7811Z"
        fill="currentColor"
      />
      <Path
...
const CloudConnectionBroken = ({
  ...
  return (
    ...
    >
      <Path
        d="M6.40996 9.50993C3.61996 1.74993 15.41 -1.34009 16.76 6.79991C20.18 7.22991 21.76 11.3899 19.88 14.0199"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M6.3707 9.51001C2.2907 9.80001 2.3007 15.71 6.3707 16H16.0307"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M10 21C10 19.9 10.9 19 12 19C13.1 19 14 19.9 14 21C14 22.1 13.1 23 12 23"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const CloudConnectionBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        opacity="0.4"
        d="M19.2007 14.7799C18.3407 15.5699 17.2007 16.0099 16.0307 15.9999H6.3707C2.3007 15.7099 2.2907 9.79993 6.3707 9.50993H6.41071C3.62071 1.74993 15.4107 -1.34009 16.7607 6.79991C20.5307 7.27991 22.0607 12.2899 19.2007 14.7799Z"
        fill="currentColor"
      />
      <Path
        d="M18.75 21C18.75 21.41 18.41 21.75 18 21.75H14C13.95 21.75 13.91 21.75 13.86 21.73C13.57 22.47 12.84 23 12 23C11.16 23 10.43 22.47 10.14 21.73C10.09 21.75 10.05 21.75 10 21.75H6C5.59 21.75 5.25 21.41 5.25 21C5.25 20.59 5.59 20.25 6 20.25H10C10.05 20.25 10.09 20.25 10.14 20.27C10.34 19.75 10.75 19.34 11.27 19.14C11.25 19.09 11.25 19.05 11.25 19V16H12.75V19C12.75 19.05 12.75 19.09 12.73 19.14C13.25 19.34 13.66 19.75 13.86 20.27C13.91 20.25 13.95 20.25 14 20.25H18C18.41 20.25 18.75 20.59 18.75 21Z"
...
const CloudConnectionTwotone = ({
  ...
  return (
    ...
    >
      <Path
        d="M6.36973 9.51017C2.28973 9.80017 2.29973 15.7102 6.36973 16.0002H16.0297C17.1997 16.0102 18.3297 15.5702 19.1997 14.7802C22.0597 12.2802 20.5297 7.28015 16.7597 6.80015C15.4097 -1.33985 3.61974 1.75017 6.40974 9.51017"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const variants: IconVariants = {
  bold: CloudConnectionBold,
  broken: CloudConnectionBroken,
  bulk: CloudConnectionBulk,
  linear: CloudConnectionLinear,
  outline: CloudConnectionOutline,
  twotone: CloudConnectionTwotone,
};
