...
const EmojiHappyBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const EmojiHappyBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const EmojiHappyBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const EmojiHappyLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const EmojiHappyOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const EmojiHappyTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: EmojiHappyBold,
  broken: EmojiHappyBroken,
  bulk: EmojiHappyBulk,
  linear: EmojiHappyLinear,
  outline: EmojiHappyOutline,
  twotone: EmojiHappyTwotone,
};

export const EmojiHappyIcon = ({ variant = "linear", ...props }: IconProps) => {
