...
const FlashBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const FlashBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M22.0004 12.63C22.6604 11.88 22.1304 10.71 21.1304 10.71H18.0404V3.50996C18.0404 2.44996 16.7204 1.94996 16.0204 2.74996L8.45043 11.35C7.79043 12.1 8.32043 13.27 9.32043 13.27H12.4104V20.47C12.4104 21.53 13.7304 22.03 14.4304 21.23L19.0604 15.97"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const FlashBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const FlashLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const FlashOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const FlashTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  ...
  twotone: FlashTwotone,
};

export const FlashIcon = ({ variant = "linear", ...props }: IconProps) => {
