...
const SmsSearchBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M22.65 21.4489L21.9 20.6989C22.29 20.1089 22.52 19.3989 22.52 18.6389C22.52 16.5589 20.84 14.8789 18.76 14.8789C16.68 14.8789 15 16.5589 15 18.6289C15 20.6989 16.68 22.3889 18.76 22.3889C19.52 22.3889 20.23 22.1589 20.82 21.7689L21.57 22.5189C21.72 22.6689 21.91 22.7389 22.11 22.7389C22.31 22.7389 22.5 22.6689 22.65 22.5189C22.95 22.2289 22.95 21.7489 22.65 21.4489Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const SmsSearchBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M12 20.4999H7C4 20.4999 2 18.9999 2 15.4999V12.4399"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const SmsSearchBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M17.586 8.53196C17.8445 8.85561 17.7917 9.32754 17.4681 9.58605L14.3372 12.0868C13.0338 13.1244 10.9563 13.1244 9.65289 12.0868L9.65104 12.0853L6.53105 9.58531C6.2078 9.3263 6.15573 8.85429 6.41474 8.53105C6.67375 8.2078 7.14576 8.15573 7.46901 8.41474L10.588 10.914C11.3446 11.5155 12.6462 11.5154 13.4025 10.9135C13.4027 10.9135 13.4024 10.9136 13.4025 10.9135L16.532 8.41401C16.8556 8.15551 17.3275 8.20832 17.586 8.53196Z"
        fill="currentColor"
      />
      <Path
        d="M22.6609 21.47L21.9209 20.73C22.3009 20.15 22.5309 19.45 22.5309 18.7C22.5309 16.66 20.8708 15 18.8308 15C16.7908 15 15.1309 16.66 15.1309 18.7C15.1309 20.74 16.7908 22.4 18.8308 22.4C19.5808 22.4 20.2808 22.17 20.8608 21.79L21.6009 22.53C21.7509 22.68 21.9409 22.75 22.1309 22.75C22.3209 22.75 22.5109 22.68 22.6609 22.53C22.9509 22.24 22.9509 21.76 22.6609 21.47Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const SmsSearchLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const SmsSearchOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const SmsSearchTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: SmsSearchBold,
  broken: SmsSearchBroken,
  bulk: SmsSearchBulk,
  linear: SmsSearchLinear,
  outline: SmsSearchOutline,
  twotone: SmsSearchTwotone,
};

export const SmsSearchIcon = ({ variant = "linear", ...props }: IconProps) => {
