...
const MoneyTimeBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyTimeBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyTimeBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyTimeLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyTimeOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const MoneyTimeTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: MoneyTimeBold,
  broken: MoneyTimeBroken,
  bulk: MoneyTimeBulk,
  linear: MoneyTimeLinear,
  outline: MoneyTimeOutline,
  twotone: MoneyTimeTwotone,
};

export const MoneyTimeIcon = ({ variant = "linear", ...props }: IconProps) => {
