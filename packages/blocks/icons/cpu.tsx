...
const CpuBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M10.02 16.2483H13.99C15.24 16.2483 16.26 15.2383 16.26 13.9783V10.0083C16.26 8.75828 15.25 7.73828 13.99 7.73828H10.02C8.77 7.73828 7.75 8.74828 7.75 10.0083V13.9783C7.75 15.2383 8.76 16.2483 10.02 16.2483Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const CpuBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CpuBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CpuLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CpuOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CpuTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
export const CpuIcon = ({ variant = "linear", ...props }: IconProps) => {
