...
const I3DRotateBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const I3DRotateBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const I3DRotateBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const I3DRotateLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const I3DRotateOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const I3DRotateTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: I3DRotateBold,
  broken: I3DRotateBroken,
  bulk: I3DRotateBulk,
  linear: I3DRotateLinear,
  outline: I3DRotateOutline,
  twotone: I3DRotateTwotone,
};

export const I3DRotateIcon = ({ variant = "linear", ...props }: IconProps) => {
