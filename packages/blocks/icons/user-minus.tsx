...
const UserMinusBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const UserMinusBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const UserMinusBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      <Path
        opacity="0.4"
        d="M21.0902 21.5C21.0902 21.78 20.8702 22 20.5902 22H3.41016C3.13016 22 2.91016 21.78 2.91016 21.5C2.91016 17.36 6.99018 14 12.0002 14C13.0302 14 14.0302 14.14 14.9502 14.41C14.3602 15.11 14.0002 16.02 14.0002 17C14.0002 17.75 14.2102 18.46 14.5802 19.06C14.7802 19.4 15.0402 19.71 15.3402 19.97C16.0402 20.61 16.9702 21 18.0002 21C19.1202 21 20.1302 20.54 20.8502 19.8C21.0102 20.34 21.0902 20.91 21.0902 21.5Z"
        fill="currentColor"
      />
      <Path
...
const UserMinusLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const UserMinusOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const UserMinusTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: UserMinusBold,
  broken: UserMinusBroken,
  bulk: UserMinusBulk,
  linear: UserMinusLinear,
  outline: UserMinusOutline,
  twotone: UserMinusTwotone,
};

export const UserMinusIcon = ({ variant = "linear", ...props }: IconProps) => {
