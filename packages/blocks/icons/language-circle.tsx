...
const LanguageCircleBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const LanguageCircleBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const LanguageCircleOutline = ({
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M17.0012 17.47C15.0312 17.47 13.2012 16.49 11.8612 14.7C11.6112 14.37 11.6812 13.9 12.0112 13.65C12.3412 13.4 12.8112 13.47 13.0612 13.8C14.1212 15.2 15.5212 15.97 17.0112 15.97C17.4212 15.97 17.7612 16.31 17.7612 16.72C17.7612 17.13 17.4112 17.47 17.0012 17.47Z"
        fill="currentColor"
      />
      <Path
...
const variants: IconVariants = {
  bold: LanguageCircleBold,
  broken: LanguageCircleBroken,
  bulk: LanguageCircleBulk,
  linear: LanguageCircleLinear,
  outline: LanguageCircleOutline,
  twotone: LanguageCircleTwotone,
};
