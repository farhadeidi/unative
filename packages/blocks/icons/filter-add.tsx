...
const FilterAddBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const FilterAddBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const FilterAddBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const FilterAddLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const FilterAddOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M18.6594 15.48H15.1094C14.6994 15.48 14.3594 15.14 14.3594 14.73C14.3594 14.32 14.6994 13.98 15.1094 13.98H18.6594C19.0694 13.98 19.4094 14.32 19.4094 14.73C19.4094 15.14 19.0694 15.48 18.6594 15.48Z"
        fill="currentColor"
      />
      <Path
        d="M16.8789 17.29C16.4689 17.29 16.1289 16.95 16.1289 16.54V13C16.1289 12.59 16.4689 12.25 16.8789 12.25C17.2889 12.25 17.6289 12.59 17.6289 13V16.55C17.6289 16.96 17.2989 17.29 16.8789 17.29Z"
        fill="currentColor"
      />
      <Path
...
const FilterAddTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: FilterAddBold,
  broken: FilterAddBroken,
  bulk: FilterAddBulk,
  linear: FilterAddLinear,
  outline: FilterAddOutline,
  twotone: FilterAddTwotone,
};

export const FilterAddIcon = ({ variant = "linear", ...props }: IconProps) => {
