...
const RadioBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const RadioBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M2 14.05V17C2 20 4 22 7 22H17C20 22 22 20 22 17V10C22 7 20 5 17 5H7C4 5 2 7 2 10"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M8.5 16C7.12 16 6 14.88 6 13.5C6 12.12 7.12 11 8.5 11C9.88 11 11 12.12 11 13.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const RadioBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M7.88086 16C9.26157 16 10.3809 14.8807 10.3809 13.5C10.3809 12.1193 9.26157 11 7.88086 11C6.50015 11 5.38086 12.1193 5.38086 13.5C5.38086 14.8807 6.50015 16 7.88086 16Z"
        fill="currentColor"
      />
      <Path
        d="M17.8809 12.25H13.8809C13.4709 12.25 13.1309 11.91 13.1309 11.5C13.1309 11.09 13.4709 10.75 13.8809 10.75H17.8809C18.2909 10.75 18.6309 11.09 18.6309 11.5C18.6309 11.91 18.2909 12.25 17.8809 12.25Z"
        fill="currentColor"
      />
      <Path
        d="M14.3809 16.25H13.8809C13.4709 16.25 13.1309 15.91 13.1309 15.5C13.1309 15.09 13.4709 14.75 13.8809 14.75H14.3809C14.7909 14.75 15.1309 15.09 15.1309 15.5C15.1309 15.91 14.7909 16.25 14.3809 16.25Z"
        fill="currentColor"
      />
      <Path
        d="M17.8809 16.25H17.3809C16.9709 16.25 16.6309 15.91 16.6309 15.5C16.6309 15.09 16.9709 14.75 17.3809 14.75H17.8809C18.2909 14.75 18.6309 15.09 18.6309 15.5C18.6309 15.91 18.2909 16.25 17.8809 16.25Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const RadioLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M17 5H7C4 5 2 7 2 10V17C2 20 4 22 7 22H17C20 22 22 20 22 17V10C22 7 20 5 17 5Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const RadioOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const RadioTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  ...
  twotone: RadioTwotone,
};

export const RadioIcon = ({ variant = "linear", ...props }: IconProps) => {
