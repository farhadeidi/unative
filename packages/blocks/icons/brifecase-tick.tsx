...
const BrifecaseTickBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BrifecaseTickBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M10.4395 14.3001L11.0895 14.9501C11.2795 15.1401 11.5895 15.1401 11.7795 14.9601L13.5595 13.3201"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const BrifecaseTickBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BrifecaseTickLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BrifecaseTickTwotone = ({
  ...
  return (
    ...
    >
      <Path
        opacity="0.4"
        d="M10.4395 14.2998L11.0895 14.9498C11.2795 15.1398 11.5895 15.1398 11.7795 14.9598L13.5595 13.3198"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const variants: IconVariants = {
  bold: BrifecaseTickBold,
  broken: BrifecaseTickBroken,
  bulk: BrifecaseTickBulk,
  linear: BrifecaseTickLinear,
  outline: BrifecaseTickOutline,
  twotone: BrifecaseTickTwotone,
};

export const BrifecaseTickIcon = ({
