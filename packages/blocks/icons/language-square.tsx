...
const LanguageSquareBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const LanguageSquareBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: LanguageSquareBold,
  broken: LanguageSquareBroken,
  bulk: LanguageSquareBulk,
  linear: LanguageSquareLinear,
  outline: LanguageSquareOutline,
  twotone: LanguageSquareTwotone,
};
