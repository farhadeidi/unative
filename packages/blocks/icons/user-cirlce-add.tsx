...
const UserCirlceAddBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const UserCirlceAddBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const UserCirlceAddBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const UserCirlceAddLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: UserCirlceAddBold,
  broken: UserCirlceAddBroken,
  bulk: UserCirlceAddBulk,
  linear: UserCirlceAddLinear,
  outline: UserCirlceAddOutline,
  twotone: UserCirlceAddTwotone,
};

export const UserCirlceAddIcon = ({
  variant = "linear",
  className,
  ...props
}: IconProps) => {
