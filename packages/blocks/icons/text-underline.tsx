...
const TextUnderlineBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TextUnderlineBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M12 17C15.87 17 19 13.87 19 10V3"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M5 3V10C5 12.17 5.98 14.1 7.53 15.38"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const TextUnderlineBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M16.8299 18.96H7.16992C6.75992 18.96 6.41992 18.62 6.41992 18.21C6.41992 17.8 6.75992 17.46 7.16992 17.46H16.8399C17.2499 17.46 17.5899 17.8 17.5899 18.21C17.5899 18.62 17.2499 18.96 16.8299 18.96Z"
        fill="currentColor"
      />
      <Path
        d="M11.9999 16.2C8.91992 16.2 6.41992 13.7 6.41992 10.62V5.79004C6.41992 5.38004 6.75992 5.04004 7.16992 5.04004C7.57992 5.04004 7.91992 5.38004 7.91992 5.79004V10.62C7.91992 12.87 9.74992 14.7 11.9999 14.7C14.2499 14.7 16.0799 12.87 16.0799 10.62V5.79004C16.0799 5.38004 16.4199 5.04004 16.8299 5.04004C17.2399 5.04004 17.5799 5.38004 17.5799 5.79004V10.62C17.5799 13.7 15.0799 16.2 11.9999 16.2Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const TextUnderlineLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  ...
  broken: TextUnderlineBroken,
  bulk: TextUnderlineBulk,
  linear: TextUnderlineLinear,
  outline: TextUnderlineOutline,
  twotone: TextUnderlineTwotone,
};
