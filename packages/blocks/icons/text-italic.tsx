...
const TextItalicBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TextItalicBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TextItalicBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M15.8706 6.00977H10.4906C10.0806 6.00977 9.74062 6.34977 9.74062 6.75977C9.74062 7.16977 10.0806 7.50977 10.4906 7.50977H12.3806L10.1406 16.4798H8.14063C7.73063 16.4798 7.39062 16.8198 7.39062 17.2298C7.39062 17.6398 7.73063 17.9798 8.14063 17.9798H13.5206C13.9306 17.9798 14.2706 17.6398 14.2706 17.2298C14.2706 16.8198 13.9306 16.4798 13.5206 16.4798H11.6806L13.9206 7.50977H15.8706C16.2806 7.50977 16.6206 7.16977 16.6206 6.75977C16.6206 6.34977 16.2806 6.00977 15.8706 6.00977Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const TextItalicLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TextItalicOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TextItalicTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: TextItalicBold,
  broken: TextItalicBroken,
  bulk: TextItalicBulk,
  linear: TextItalicLinear,
  outline: TextItalicOutline,
  twotone: TextItalicTwotone,
};

export const TextItalicIcon = ({ variant = "linear", ...props }: IconProps) => {
