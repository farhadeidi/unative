...
const CardRemove1Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardRemove1Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardRemove1Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardRemove1Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardRemove1Outline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M17.31 8.94023C17.12 8.94023 16.93 8.87023 16.78 8.72023C16.49 8.43023 16.49 7.95023 16.78 7.66023L20.67 3.77023C20.96 3.48023 21.44 3.48023 21.73 3.77023C22.02 4.06023 22.02 4.54023 21.73 4.83023L17.84 8.72023C17.69 8.87023 17.5 8.94023 17.31 8.94023Z"
        fill="currentColor"
      />
      <Path
        d="M21.1902 8.94023C21.0002 8.94023 20.8102 8.87023 20.6602 8.72023L16.7702 4.83023C16.4802 4.54023 16.4802 4.06023 16.7702 3.77023C17.0602 3.48023 17.5402 3.48023 17.8302 3.77023L21.7202 7.66023C22.0102 7.95023 22.0102 8.43023 21.7202 8.72023C21.5802 8.87023 21.3902 8.94023 21.1902 8.94023Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const CardRemove1Twotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: CardRemove1Bold,
  broken: CardRemove1Broken,
  bulk: CardRemove1Bulk,
  linear: CardRemove1Linear,
  outline: CardRemove1Outline,
  twotone: CardRemove1Twotone,
};

export const CardRemove1Icon = ({
