...
const BuildingsBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BuildingsBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M2 11C2 9 3 8 5 8H10V19C10 21 11 22 13 22H5C3 22 2 21 2 19V15"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const BuildingsBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BuildingsLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BuildingsOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BuildingsTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: BuildingsBold,
  broken: BuildingsBroken,
  bulk: BuildingsBulk,
  linear: BuildingsLinear,
  outline: BuildingsOutline,
  twotone: BuildingsTwotone,
};

export const BuildingsIcon = ({ variant = "linear", ...props }: IconProps) => {
