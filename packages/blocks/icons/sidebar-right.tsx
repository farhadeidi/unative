...
const SidebarRightBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M16.7793 2.03125V21.9812C18.0093 21.9012 19.0493 21.5513 19.8693 20.9513C20.2893 20.6612 20.6593 20.2913 20.9493 19.8713C21.6393 18.9212 21.9993 17.6813 21.9993 16.1913V7.81125C21.9993 4.37125 20.0593 2.24125 16.7793 2.03125Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const SidebarRightBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const SidebarRightBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M15.2793 2V22H16.1893C16.3893 22 16.5893 21.99 16.7793 21.98V2.03C16.5893 2.01 16.3893 2 16.1893 2H15.2793Z"
        fill="currentColor"
      />
      <Path
        d="M9.0307 15.3099C9.2207 15.3099 9.4107 15.2399 9.5607 15.0899L12.1207 12.5299C12.4107 12.2399 12.4107 11.7599 12.1207 11.4699L9.5607 8.90988C9.2707 8.61988 8.7907 8.61988 8.5007 8.90988C8.2107 9.19988 8.2107 9.67988 8.5007 9.96988L10.5207 11.9999L8.5007 14.0299C8.2107 14.3199 8.2107 14.7999 8.5007 15.0899C8.6407 15.2399 8.8307 15.3099 9.0307 15.3099Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const SidebarRightLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const SidebarRightOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const SidebarRightTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: SidebarRightBold,
  broken: SidebarRightBroken,
  bulk: SidebarRightBulk,
  linear: SidebarRightLinear,
  outline: SidebarRightOutline,
  twotone: SidebarRightTwotone,
};
