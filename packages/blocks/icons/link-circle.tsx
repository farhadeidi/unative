...
const LinkCircleBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const LinkCircleBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M7.9407 14.5099C7.3207 14.2799 6.7707 13.8299 6.4207 13.1899C5.6207 11.7299 6.1107 9.82989 7.5307 8.94989L9.8707 7.49988C11.2807 6.61988 13.1007 7.09987 13.9007 8.54987C14.7007 10.0099 14.2107 11.9099 12.7907 12.7899L12.4807 13.0099"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M16.1092 9.44995C16.7292 9.67995 17.2792 10.1299 17.6292 10.7699C18.4292 12.2299 17.9392 14.1299 16.5192 15.0099L14.1792 16.4599C12.7692 17.3399 10.9492 16.8599 10.1492 15.4099C9.34921 13.9499 9.83922 12.05 11.2592 11.17L11.5692 10.95"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const LinkCircleBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const LinkCircleLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const LinkCircleOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const LinkCircleTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      <Path
        opacity="0.4"
        d="M16.1092 9.4502C16.7292 9.6802 17.2792 10.1302 17.6292 10.7702C18.4292 12.2302 17.9392 14.1302 16.5192 15.0102L14.1792 16.4602C12.7692 17.3402 10.9492 16.8602 10.1492 15.4102C9.34921 13.9502 9.83922 12.0502 11.2592 11.1702L11.5692 10.9502"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const variants: IconVariants = {
  bold: LinkCircleBold,
  broken: LinkCircleBroken,
  bulk: LinkCircleBulk,
  linear: LinkCircleLinear,
  outline: LinkCircleOutline,
  twotone: LinkCircleTwotone,
};

export const LinkCircleIcon = ({ variant = "linear", ...props }: IconProps) => {
