...
const CalendarSearchBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CalendarSearchBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: CalendarSearchBold,
  broken: CalendarSearchBroken,
  bulk: CalendarSearchBulk,
  linear: CalendarSearchLinear,
  outline: CalendarSearchOutline,
  twotone: CalendarSearchTwotone,
};
