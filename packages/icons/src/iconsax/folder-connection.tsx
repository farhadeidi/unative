...
const FolderConnectionBroken = ({
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M5 5.5C5 2.7 5.7 2 8.5 2H9.54999C10.6 2 10.83 2.30997 11.23 2.83997L12.28 4.23999C12.55 4.58999 12.7 4.80005 13.4 4.80005H15.5C18.3 4.80005 19 5.50005 19 8.30005V12.5C19 15.3 18.3 16 15.5 16H8.5C5.7 16 5 15.3 5 12.5V9.33997"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const variants: IconVariants = {
  bold: FolderConnectionBold,
  broken: FolderConnectionBroken,
  bulk: FolderConnectionBulk,
  linear: FolderConnectionLinear,
  outline: FolderConnectionOutline,
  twotone: FolderConnectionTwotone,
};

export const FolderConnectionIcon = ({
