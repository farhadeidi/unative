...
const CardReceiveBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardReceiveBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardReceiveBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardReceiveLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const CardReceiveOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M19.9995 10.2499C19.8095 10.2499 19.6195 10.1799 19.4695 10.0299L17.4695 8.02994C17.1795 7.73994 17.1795 7.25994 17.4695 6.96994C17.7595 6.67994 18.2395 6.67994 18.5295 6.96994L20.5295 8.96994C20.8195 9.25994 20.8195 9.73994 20.5295 10.0299C20.3795 10.1799 20.1895 10.2499 19.9995 10.2499Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const CardReceiveTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: CardReceiveBold,
  broken: CardReceiveBroken,
  bulk: CardReceiveBulk,
  linear: CardReceiveLinear,
  outline: CardReceiveOutline,
  twotone: CardReceiveTwotone,
};

export const CardReceiveIcon = ({
