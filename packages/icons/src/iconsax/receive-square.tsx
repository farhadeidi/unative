...
const ReceiveSquareBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ReceiveSquareBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ReceiveSquareBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ReceiveSquareLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ReceiveSquareOutline = ({
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M11.9995 15.26C11.8095 15.26 11.6195 15.1899 11.4695 15.0399L8.46945 12.0399C8.17945 11.7499 8.17945 11.27 8.46945 10.98C8.75945 10.69 9.23945 10.69 9.52945 10.98L11.9995 13.45L14.4695 10.98C14.7595 10.69 15.2395 10.69 15.5295 10.98C15.8195 11.27 15.8195 11.7499 15.5295 12.0399L12.5295 15.0399C12.3795 15.1899 12.1895 15.26 11.9995 15.26Z"
        fill="currentColor"
      />
      <Path
...
const variants: IconVariants = {
  bold: ReceiveSquareBold,
  broken: ReceiveSquareBroken,
  bulk: ReceiveSquareBulk,
  linear: ReceiveSquareLinear,
  outline: ReceiveSquareOutline,
  twotone: ReceiveSquareTwotone,
};
