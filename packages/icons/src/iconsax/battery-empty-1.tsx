...
const BatteryEmpty1Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BatteryEmpty1Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M6.38086 10C6.62086 10.98 6.69086 11.99 6.57086 12.99C6.53086 13.33 6.47086 13.67 6.38086 14"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const BatteryEmpty1Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const BatteryEmpty1Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: BatteryEmpty1Bold,
  broken: BatteryEmpty1Broken,
  bulk: BatteryEmpty1Bulk,
  linear: BatteryEmpty1Linear,
  outline: BatteryEmpty1Outline,
  twotone: BatteryEmpty1Twotone,
};
