...
const SearchZoomIn1Bold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const SearchZoomIn1Broken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const SearchZoomIn1Bulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const SearchZoomIn1Linear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: SearchZoomIn1Bold,
  broken: SearchZoomIn1Broken,
  bulk: SearchZoomIn1Bulk,
  linear: SearchZoomIn1Linear,
  outline: SearchZoomIn1Outline,
  twotone: SearchZoomIn1Twotone,
};
