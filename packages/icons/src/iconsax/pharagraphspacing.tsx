...
const PharagraphspacingOutline = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
  return (
    ...
    >
      ...
      />
      <Path
        d="M14.8294 8.4699C14.6394 8.4699 14.4494 8.3999 14.2994 8.2499L11.9994 5.9499L9.69937 8.2499C9.40937 8.5399 8.92937 8.5399 8.63938 8.2499C8.34938 7.9599 8.34938 7.4799 8.63938 7.1899L11.4694 4.3599C11.7494 4.0799 12.2494 4.0799 12.5294 4.3599L15.3594 7.1899C15.6494 7.4799 15.6494 7.9599 15.3594 8.2499C15.2094 8.3999 15.0194 8.4699 14.8294 8.4699Z"
        fill="currentColor"
      />
      <Path
        d="M11.9994 19.4701C11.7994 19.4701 11.6094 19.3901 11.4694 19.2501L8.63938 16.4201C8.34938 16.1301 8.34938 15.6501 8.63938 15.3601C8.92937 15.0701 9.40937 15.0701 9.69937 15.3601L11.9994 17.6601L14.2994 15.3601C14.5894 15.0701 15.0694 15.0701 15.3594 15.3601C15.6494 15.6501 15.6494 16.1301 15.3594 16.4201L12.5294 19.2501C12.3894 19.3901 12.1994 19.4701 11.9994 19.4701Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const PharagraphspacingTwotone = ({
  size = 24,
  className,
  ...props
}: IconProps) => {
  return (
    ...
    >
      ...
      <G opacity="0.4">
        ...
        />
        <Path
          d="M14.8299 7.71965L11.9999 4.88965L9.16992 7.71965"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <Path
          d="M14.8299 15.8896L11.9999 18.7196L9.16992 15.8896"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
...
const variants: IconVariants = {
  bold: PharagraphspacingBold,
  broken: PharagraphspacingBroken,
  bulk: PharagraphspacingBulk,
  linear: PharagraphspacingLinear,
  outline: PharagraphspacingOutline,
  twotone: PharagraphspacingTwotone,
};
...
export default PharagraphspacingIcon;
