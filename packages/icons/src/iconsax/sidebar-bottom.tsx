...
const SidebarBottomBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Path
        d="M3.04953 19.8713C3.33953 20.2913 3.70953 20.6613 4.12953 20.9513C5.07953 21.6413 6.31953 22.0012 7.80953 22.0012H16.1895C19.6295 22.0012 21.7595 20.0612 21.9695 16.7812H2.01953C2.09953 18.0113 2.44953 19.0513 3.04953 19.8713Z"
        fill="currentColor"
      />
      <Path
...
const SidebarBottomBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M14.5595 8.5L11.9995 11.06L9.43945 8.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <Path
        d="M1.9707 11.02V9C1.9707 4 3.9707 2 8.9707 2H14.9707C19.9707 2 21.9707 4 21.9707 9V15C21.9707 20 19.9707 22 14.9707 22H8.9707C3.9707 22 1.9707 20 1.9707 15"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const SidebarBottomBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M22 15.2798H2V16.1898C2 16.3898 2.01 16.5898 2.02 16.7798H21.97C21.99 16.5898 22 16.3898 22 16.1898V15.2798Z"
        fill="currentColor"
      />
      <Path
        d="M8.68945 9.0299C8.68945 9.2199 8.75945 9.4099 8.90945 9.5599L11.4695 12.1199C11.7595 12.4099 12.2395 12.4099 12.5295 12.1199L15.0895 9.5599C15.3795 9.2699 15.3795 8.7899 15.0895 8.4999C14.7995 8.2099 14.3195 8.2099 14.0295 8.4999L11.9995 10.5199L9.96945 8.4999C9.67945 8.1999 9.19945 8.1999 8.90945 8.4999C8.75945 8.6399 8.68945 8.8299 8.68945 9.0299Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const SidebarBottomLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: SidebarBottomBold,
  broken: SidebarBottomBroken,
  bulk: SidebarBottomBulk,
  linear: SidebarBottomLinear,
  outline: SidebarBottomOutline,
  twotone: SidebarBottomTwotone,
};
