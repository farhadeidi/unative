...
const ClipboardExportBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ClipboardExportBroken = ({
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M10.9991 2H10.0391C9.03906 2 8.03906 2 8.03906 4C8.03906 6 9.03906 6 10.0391 6H14.0391C16.0391 6 16.0391 5 16.0391 4C16.0391 2 15.0391 2 14.0391 2"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const ClipboardExportBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ClipboardExportOutline = ({
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M21.0009 15.7499C20.5909 15.7499 20.2509 15.4099 20.2509 14.9999V9.99993C20.2509 5.77993 18.8009 4.92993 15.9609 4.76993C15.5509 4.74993 15.2309 4.38993 15.2509 3.97993C15.2709 3.56993 15.6309 3.24993 16.0409 3.26993C20.1009 3.48993 21.7509 5.43993 21.7509 9.98993V14.9899C21.7509 15.4099 21.4109 15.7499 21.0009 15.7499Z"
        fill="currentColor"
      />
      <Path
      ...
      />
      <Path
        d="M21.0005 22.75C20.8105 22.75 20.6205 22.68 20.4705 22.53L14.5105 16.57C14.2205 16.28 14.2205 15.8 14.5105 15.51C14.8005 15.22 15.2805 15.22 15.5705 15.51L21.5305 21.47C21.8205 21.76 21.8205 22.24 21.5305 22.53C21.3805 22.68 21.1905 22.75 21.0005 22.75Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const variants: IconVariants = {
  bold: ClipboardExportBold,
  broken: ClipboardExportBroken,
  bulk: ClipboardExportBulk,
  linear: ClipboardExportLinear,
  outline: ClipboardExportOutline,
  twotone: ClipboardExportTwotone,
};

export const ClipboardExportIcon = ({
