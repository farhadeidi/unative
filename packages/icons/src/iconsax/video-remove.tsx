...
const VideoRemoveBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const VideoRemoveBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M19.7003 19.6801L17.3203 17.3"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M19.6808 17.3201L17.3008 19.7001"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const VideoRemoveBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const VideoRemoveLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M19.7001 19.6801L17.3201 17.3"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
...
const VideoRemoveOutline = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M19.6998 20.4302C19.5098 20.4302 19.3198 20.3602 19.1698 20.2102L16.7898 17.8302C16.4998 17.5402 16.4998 17.0602 16.7898 16.7702C17.0798 16.4802 17.5598 16.4802 17.8498 16.7702L20.2298 19.1502C20.5198 19.4402 20.5198 19.9202 20.2298 20.2102C20.0898 20.3502 19.8898 20.4302 19.6998 20.4302Z"
        fill="currentColor"
      />
      <Path
        d="M17.3002 20.4498C17.1102 20.4498 16.9202 20.3798 16.7702 20.2298C16.4802 19.9398 16.4802 19.4598 16.7702 19.1698L19.1502 16.7898C19.4402 16.4998 19.9202 16.4998 20.2102 16.7898C20.5002 17.0798 20.5002 17.5598 20.2102 17.8498L17.8302 20.2298C17.6802 20.3798 17.4902 20.4498 17.3002 20.4498Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const VideoRemoveTwotone = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      <G opacity="0.4">
        <Path
          d="M19.7003 19.6798L17.3203 17.2998"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeMiterlimit="10"
          strokeLinecap="round"
        ...
        />
        <Path
          d="M19.6808 17.3198L17.3008 19.6998"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeMiterlimit="10"
          strokeLinecap="round"
...
const variants: IconVariants = {
  bold: VideoRemoveBold,
  broken: VideoRemoveBroken,
  bulk: VideoRemoveBulk,
  linear: VideoRemoveLinear,
  outline: VideoRemoveOutline,
  twotone: VideoRemoveTwotone,
};

export const VideoRemoveIcon = ({
