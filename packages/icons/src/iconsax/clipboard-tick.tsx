...
const ClipboardTickBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ClipboardTickBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ClipboardTickBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path
        d="M10.81 16.9501C10.62 16.9501 10.43 16.8801 10.28 16.7301L8.78 15.2301C8.49 14.9401 8.49 14.4601 8.78 14.1701C9.07 13.8801 9.55 13.8801 9.84 14.1701L10.81 15.1401L14.28 11.6701C14.57 11.3801 15.05 11.3801 15.34 11.6701C15.63 11.9601 15.63 12.4401 15.34 12.7301L11.34 16.7301C11.2 16.8801 11 16.9501 10.81 16.9501Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const ClipboardTickLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const ClipboardTickTwotone = ({
  ...
  return (
    ...
    >
      <Path
        opacity="0.4"
        d="M9.31055 14.7002L10.8105 16.2002L14.8105 12.2002"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const variants: IconVariants = {
  bold: ClipboardTickBold,
  broken: ClipboardTickBroken,
  bulk: ClipboardTickBulk,
  linear: ClipboardTickLinear,
  outline: ClipboardTickOutline,
  twotone: ClipboardTickTwotone,
};
