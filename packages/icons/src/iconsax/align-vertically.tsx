...
const AlignVerticallyBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const AlignVerticallyBroken = ({
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M15.4 5.25H8.6C7.1 5.25 6.5 5.89 6.5 7.48V8.52C6.5 10.11 7.1 10.75 8.6 10.75H15.4C16.9 10.75 17.5 10.11 17.5 8.52"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const AlignVerticallyBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: AlignVerticallyBold,
  broken: AlignVerticallyBroken,
  bulk: AlignVerticallyBulk,
  linear: AlignVerticallyLinear,
  outline: AlignVerticallyOutline,
  twotone: AlignVerticallyTwotone,
};

export const AlignVerticallyIcon = ({
