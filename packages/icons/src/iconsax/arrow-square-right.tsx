...
const variants: IconVariants = {
  ...
  broken: ArrowSquareRightBroken,
  bulk: ArrowSquareRightBulk,
  linear: ArrowSquareRightLinear,
  outline: ArrowSquareRightOutline,
  twotone: ArrowSquareRightTwotone,
};
