...
const DocumentForwardBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const DocumentForwardBroken = ({
  ...
  return (
    ...
    >
      <Path
        d="M10.3496 15H12.9996L10.9996 17"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
const DocumentForwardBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const variants: IconVariants = {
  bold: DocumentForwardBold,
  broken: DocumentForwardBroken,
  bulk: DocumentForwardBulk,
  linear: DocumentForwardLinear,
  outline: DocumentForwardOutline,
  twotone: DocumentForwardTwotone,
};
