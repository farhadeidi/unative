...
const variants: IconVariants = {
  bold: DocumentDownloadBold,
  broken: DocumentDownloadBroken,
  bulk: DocumentDownloadBulk,
  linear: DocumentDownloadLinear,
  outline: DocumentDownloadOutline,
  twotone: DocumentDownloadTwotone,
};
