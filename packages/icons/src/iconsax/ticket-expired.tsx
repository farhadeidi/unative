...
const TicketExpiredBold = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TicketExpiredBroken = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TicketExpiredBulk = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TicketExpiredLinear = ({ size = 24, className, ...props }: IconProps) => {
  return (
    <Svg
      width={size}
      height={size}
...
const TicketExpiredOutline = ({
  ...
  return (
    ...
    >
      <Path
        d="M17.3802 20.75H10.9102C10.5002 20.75 10.1602 20.41 10.1602 20C10.1602 19.59 10.5002 19.25 10.9102 19.25H17.3802C20.4402 19.25 21.1602 18.75 21.2402 16.03C19.9202 15.69 18.9402 14.49 18.9402 13.07C18.9402 11.64 19.9202 10.43 21.2502 10.09V9.82996C21.2502 6.53996 20.6702 5.95996 17.3802 5.95996H11.7502V12C11.7502 12.41 11.4102 12.75 11.0002 12.75C10.5902 12.75 10.2502 12.41 10.2502 12V5.20996C10.2502 4.79996 10.5902 4.45996 11.0002 4.45996H17.3802C21.5002 4.45996 22.7502 5.70996 22.7502 9.82996V10.75C22.7502 11.16 22.4102 11.5 22.0002 11.5C21.1402 11.5 20.4402 12.2 20.4402 13.07C20.4402 13.93 21.1402 14.63 22.0002 14.63C22.4102 14.63 22.7502 14.97 22.7502 15.38C22.7502 19.5 21.5002 20.75 17.3802 20.75Z"
        fill="currentColor"
      />
      <Path
        d="M11.0004 20.7502H8.23044C6.21044 20.7502 5.17044 19.2302 4.22044 16.9502L4.03044 16.4902C3.96044 16.3102 3.96044 16.1002 4.04044 15.9202C4.12044 15.7402 4.27044 15.5902 4.45044 15.5202C4.85044 15.3602 5.16044 15.0502 5.33044 14.6602C5.50044 14.2602 5.50044 13.8202 5.33044 13.4202C5.00044 12.5802 4.05044 12.1902 3.21044 12.5202C3.02044 12.6002 2.82044 12.5902 2.63044 12.5102C2.45044 12.4302 2.30044 12.2802 2.23044 12.1002L2.06044 11.6702C0.460436 7.78022 1.16044 6.11022 5.05044 4.50022L7.69044 3.42022C8.07044 3.26022 8.51044 3.45022 8.67044 3.83022L11.7004 11.1702C11.7404 11.2602 11.7604 11.3602 11.7604 11.4602V14.0002C11.7604 14.4102 11.4204 14.7502 11.0104 14.7502C10.6004 14.7502 10.2604 14.4102 10.2604 14.0002V11.6002L7.56044 5.09022L5.62044 5.89022C2.54044 7.16022 2.17044 7.94022 3.38044 10.9402C4.77044 10.7402 6.17044 11.4902 6.72044 12.8402C7.04044 13.6102 7.04044 14.4602 6.71044 15.2302C6.49044 15.7602 6.13044 16.2102 5.67044 16.5402C6.63044 18.8002 7.33044 19.2502 8.22044 19.2502H10.2404V17.0002C10.2404 16.5902 10.5804 16.2502 10.9904 16.2502C11.4004 16.2502 11.7404 16.5902 11.7404 17.0002V20.0002C11.7504 20.4102 11.4104 20.7502 11.0004 20.7502Z"
        fill="currentColor"
      />
      <Path
        d="M8.17 20.75H8C7.59 20.75 7.25 20.41 7.25 20C7.25 19.59 7.59 19.25 8 19.25H8.17C8.58 19.25 8.92 19.59 8.92 20C8.92 20.41 8.58 20.75 8.17 20.75Z"
        fill="currentColor"
      />
    </Svg>
  );
...
const variants: IconVariants = {
  bold: TicketExpiredBold,
  broken: TicketExpiredBroken,
  bulk: TicketExpiredBulk,
  linear: TicketExpiredLinear,
  outline: TicketExpiredOutline,
  twotone: TicketExpiredTwotone,
};

export const TicketExpiredIcon = ({
